...
Para produção, o componente também aceita `factory`, permitindo construir
`Kowts\Efatura\Efatura` com `PdoSequenceStore`, `PdoSubmissionRegistry`,
clientes PSR-18 e outras dependências persistentes sem criar uma subclasse.
