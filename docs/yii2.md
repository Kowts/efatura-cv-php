...
idempotência. A implementação PDO suporta SQLite, MySQL/MariaDB, PostgreSQL e
SQL Server. O componente padrão cria uma instância simples a partir de arrays;
