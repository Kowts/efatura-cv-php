...
final class EfaturaConfig
{
    ...
    /**
     * Constrói a configuração imutável a partir da estrutura usada por
     * frameworks e ficheiros de configuração.
     *
    ...
    public static function fromArray(array $config): self
    {
        ...
        return new self(
            ...
            platformBaseUrl: (string) ($config['platform_base_url'] ?? self::DEFAULT_PLATFORM_URL),
            dfaBaseUrl: (string) ($config['dfa_base_url'] ?? self::DEFAULT_DFA_URL),
