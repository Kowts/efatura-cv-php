...
O fluxo completo, com decisões de contingência, validação, assinatura,
submissão e reconciliação, está documentado em
[Arquitectura](docs/arquitectura.md#fluxo-de-emissão).
